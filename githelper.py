...
stand = "GitHelper   Software Version: 1.0, 26.11.2019"
...
class Application(ttk.Frame):
    ...
    def quit(self):
        print ("I hope you enjoyed using my Tool!")
        sys.exit(0)
    ...
    def hintergrund(self):
        Label(self, text=str("[") + ("   ") + str("]"),bg=(self.BG),fg='grey',font='Helvetica 50 bold ').place(x=320,y=70);
        Label(self, text=str("*"),bg=(self.BG),fg=(self.FGBLUE),font=((self.FONT) + ("124"))).place(x=350,y=60);
    ...
    def Werbung(self):
        ...
        self.INSTAG  = "Instagram @contactnavarra"
        
        def show_werbung(self):
            print (stand)
            print ("")
            print ("GUI to make working with Git a little easier")
            print ("")
            print ("from:")
            print (self.LOGO, self.NAVARRA)
            print (self.SLOGAN)
            print (self.WEBSITE)
            print (self.MAIL)
            print (self.CEO)
